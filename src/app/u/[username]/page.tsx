    ...
    return (
      <div className="max-w-4xl mx-auto p-4">
        <div className="p-8 text-center bg-red-50 dark:bg-red-900/20 rounded-lg">
          <h2 className="text-2xl font-bold text-red-600 dark:text-red-400 mb-2">Usuario no encontrado</h2>
          <p className="text-gray-600 dark:text-gray-300">
            No pudimos encontrar un usuario con el nombre de usuario "{username}".
          </p>
        </div>
      </div>
    )
